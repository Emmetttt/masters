...
##Combine Clusters
clusterRA = scRA + ascRA + sclusterRA + nclusterRA + pclusterRA + aclusterRA
clusterdec = scdec + ascdec + sclusterdec + nclusterdec + pclusterdec + aclusterdec
clusterz = scz + ascz + sclusterz + nclusterz + pclusterz + aclusterz
